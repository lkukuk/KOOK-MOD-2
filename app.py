...
risk_questions = [
    {"text": "1. You have an offer to invest 15% of your net worth in a deal with an 80% chance of profit. You'd say:",
     "options": {"A": "It is not worth it.", "B": "I would need a minimimum of 7x return", "C": "I would need a minimum of 3x reutn", "D": "I would need a minimum of 1x return"}},
    {"text": "2. How comfortable would you be assuming $10,000 debt for $20,000 gain?",
    ...
    {"text": "3. You have a lottery ticket with a 25% chance of wining $100,000. You would sell it for no less than:",
     "options": {"A": "$15,000", "B": "$20,000", "C": "$35,000", "D": "$60,000"}},
    {"text": "4. How often do you bet over $150 on gambling activities:",
     "options": {"A": "I would never", "B": "A few times across my lifetime", "C": "Once this year", "D": "Two or more times this year"}},
    {"text": "5. If a stock you bought doubled you would:",
     "options": {"A": "Sell all of my shares", "B": "Sell half of my shares", "C": "Hold my current shares ", "D": "I would buy more"}},
    {"text": "6. Your CD is maturing and rates are down. You would most likely put that money in which of the following?:",
     "options": {"A": "Savings bond", "B": "Short-term bond (matures in 1 to 5 years)", "C": "Long-term bond (matures in 10+ years)", "D": "Stock fund (Mutual Fund or ETF)"}},
    {"text": "7. When deciding where to invest a large sum of money you:",
     "options": {"A": "Delay the decision", "B": "Let others decide for me", "C": "Ask an advisor", "D": "I decide myself"}},
    {"text": "8. How do you make investment decisions:",
     "options": {"A": "I never decide alone", "B": "I sometimes decide alone", "C": "I often decide alone", "D": "I always decide alone"}},
